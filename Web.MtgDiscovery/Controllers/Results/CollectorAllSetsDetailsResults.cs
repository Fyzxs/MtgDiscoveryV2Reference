...
public sealed class CollectorAllSetsDetailsResults : IResults
{
    ...
    public CollectorAllSetsDetailsResults(CollectorId collectorId) : this(new InMemoryResultsCache(), new CollectorAllSetsDetailsCacheKey(collectorId), new CollectorAllSetsDetailsDeferredQuery(collectorId)) { }

    private CollectorAllSetsDetailsResults(IResultsCache resultsCache, DynamicCacheKey dynamicCacheKey, DeferredQuery<ISelfSerialize> query)
    {

...
public sealed class CollectorSetCardCountDetailsResults : IResults
{
    ...
    public CollectorSetCardCountDetailsResults(SetId setId, CollectorId collectorId) : this(new InMemoryResultsCache(), new CollectorSetCardCountDetailsCacheKey(setId, collectorId), new CollectorSetCardCountDetailsDeferredQuery(setId, collectorId)) { }

    private CollectorSetCardCountDetailsResults(IResultsCache resultsCache, DynamicCacheKey dynamicCacheKey, DeferredQuery<ISelfSerialize> query)
    {
